...
class FadeRotateTransition extends StatelessWidget {
  final Widget child;
  final Duration duration;
  final bool applyAnimation;
  const FadeRotateTransition({super.key, required this.child,this.duration=Constants.animationDuration,this.applyAnimation=true});
